...
#include <string.h>
#include <unistd.h>
#include "xfyun_new/qisr.h"
#include "xfyun_new/msp_cmn.h"
#include "xfyun_new/msp_errors.h"
#include "xfyun_new/speech_recognizer.h"
#include "ros/ros.h"
...
int main(int argc, char* argv[])
{
    ...
    // 订阅唤醒语音识别的信号
    // ros::Subscriber wakeUpSub = n.subscribe("voiceWakeup", 1000, WakeUp);   //唤醒
    // 发布voicewords话题  
    ros::Publisher voiceWordsPub = n.advertise<std_msgs::String>("voiceWords", 1000);  

    // ROS_INFO("Sleeping..."); //唤醒
    int count=0;

	int ret = MSP_SUCCESS;
	int upload_on =	1; /* whether upload the user word */
	/* login params, please do keep the appid correct */
	const char* login_params = "appid = cbb10683, work_dir = .";
